...
class TravelTasks:
    def __tip_section(self):
        return "If you do your BEST WORK, I'll give you 10% commission!"

    def plan_itinerary(self, agent, city, travel_dates, interests='Sightseeing, local food', noofdays=7):
        return Task(
            description=dedent(
                f"""
            **Task**: Develop a {noofdays}-Day Travel Itinerary
            **Description**: Expand the city guide into a full {noofdays}-day travel itinerary with detailed 
